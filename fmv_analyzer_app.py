...
# -----------------------------
def calculate_fmv(address, sq_ft, build_year, is_builder_origin, fmv_method, community, cost_level,
                  sold_price=None, sold_year=None, lot_premium=0, builder_profit_pct=15,
    ...
    if st.button("Analyze"):
        if address and sq_ft:
            fmv, risk = calculate_fmv(
                address, sq_ft, build_year, is_builder_origin, fmv_method,
                community, cost_level, sold_price, sold_year,
                lot_premium, builder_profit_pct, apply_lot_and_profit
            )
